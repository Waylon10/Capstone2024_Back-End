...
class OrderServiceTest {
    ...
    void setUp() throws Exception {
        String uniqueEmail = "johnwick20@example.com";
        Contact contact = ContactFactory.createContact(uniqueEmail, "0211234567");
        Customer customer = CustomerFactory.createCustomer(contact.getEmail(), "$2a$12$kEO/txVAOGw3GZS9X1r2n.Cok3gpuLI3O9Dgu7avsRK4Z2S6/v69m", "John", "Wick", contact);
        ...
        shipping = ShippingFactory.createShipping(savedAddress, OrderStatus.PENDING, BigDecimal.valueOf(50.00));
        Shipping savedShipping = shippingService.create(shipping); // Save the Shipping entity
        assertNotNull(savedShipping, "Saved Shipping should not be null");
    }
    ...
    void d_delete() {
        ...
        Order deletedOrder = orderService.read(savedOrder.getOrderID());
